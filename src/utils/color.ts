 ...
 * 主题色工具类
 * 用于切换框架主题色
 * 参考腾讯官方tdesign-vue-next-starter项目
...
import type { THEME_ENUM } from '/@/constants/appConstants';
import type { TColorToken } from '/@/settings/colorSetting';
/**
 * 依据主题类型获取颜色
 *
 * @export
 ...
 */
export function generateColorMap(theme: string, colorPalette: Array<string>, mode: THEME_ENUM, brandColorIdx: number) {
 ...
 * 将生成的样式嵌入头部
 */
export function insertThemeStylesheet(theme: string, colorMap: TColorToken, mode: THEME_ENUM) {
  const isDarkMode = mode === 'dark';
